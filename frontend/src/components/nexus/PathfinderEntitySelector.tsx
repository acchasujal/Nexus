...
export const GOLDEN_SUGGESTIONS: EntityOption[] = [
  { id: 'CASE-141', label: 'FIR 141/2026 — Human Trafficking', type: 'Case', subtext: 'Mysuru South WS PS • Candidate RC-1 Case' },
  { id: 'CASE-207', label: 'FIR 207/2026 — Cyber Fraud', type: 'Case', subtext: 'Bengaluru CEN PS • Candidate RC-1 Case' },
  { id: 'CASE-305', label: 'FIR 305/2026 — Cyber Fraud', type: 'Case', subtext: 'Indiranagar PS • Candidate RC-2 Case' },
  { id: 'CASE-412', label: 'FIR 412/2026 — Hawala Syndicate', type: 'Case', subtext: 'Domlur Cyber PS • Candidate RC-2 Case' },
  { id: 'CASE-501', label: 'FIR 501/2026 — Narcotics Ring', type: 'Case', subtext: 'Jayanagar PS • Candidate RC-3 Case' },
  { id: 'CASE-502', label: 'FIR 502/2026 — Extortion & Logistics', type: 'Case', subtext: 'Tilak Nagar PS • Candidate RC-3 Case' },
  ...
  { id: 'P-RAFIQ', label: 'Rafiq Khan / Rafiq Ahmed', type: 'Person', subtext: 'Unified Suspect • Cross-Case Bridge (RC-1)' },
  { id: 'P-VIKRAM-S', label: 'Vikram Sharma', type: 'Person', subtext: 'Bengaluru • Accused in FIR 305 • Candidate RC-2' },
  { id: 'P-BIKRAM-S', label: 'Bikram Sarma', type: 'Person', subtext: 'Bengaluru • Accused in FIR 412 • Candidate RC-2' },
  { id: 'P-VIKRAM', label: 'Vikram Sharma / Bikram Sarma', type: 'Person', subtext: 'Unified Suspect • Cross-Case Bridge (RC-2)' },
  { id: 'P-SUNIEL-S', label: 'Suniel Shetty (FIR 501)', type: 'Person', subtext: 'Bengaluru • Accused in FIR 501 • Candidate RC-3' },
  { id: 'P-SUNIL-S', label: 'Sunil Shetty (Alias)', type: 'Person', subtext: 'Bengaluru • Accused in FIR 502 • Candidate RC-3' },
  { id: 'P-SUNIEL', label: 'Suniel Shetty / Sunil Shetty', type: 'Person', subtext: 'Unified Suspect • Cross-Case Bridge (RC-3)' },
  { id: 'VEH-1001', label: 'KA-01-AB-1001 (Toyota Fortuner)', type: 'Vehicle', subtext: 'Seized Vehicle • Logistics Link (RC-3)' },
  ...
  { id: 'ACC-4491', label: 'ACC-4491 (HDFC Bank)', type: 'Account', subtext: 'Bikram Sarma • Hawala Route to ACC-9914' },
